...
// Make sure to put card.glb and lanyard.png inside the "public" folder of your app!
const cardGLB = process.env.PUBLIC_URL + '/card.glb';
const lanyardTex = process.env.PUBLIC_URL + '/lanyard.png';
